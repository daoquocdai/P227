# Hướng dẫn template AI20K (lưu trữ)

> Đây là README hướng dẫn chung ban đầu của template, được lưu lại để tham khảo quy trình AI20K. Nội dung sản phẩm và tài liệu kỹ thuật hiện hành nằm tại [README.md](README.md) và [docs/README.md](docs/README.md). Bộ `docs/guide/` mẫu đã được thay bằng tài liệu riêng của An Tâm Home.

## Nội dung hướng dẫn gốc
