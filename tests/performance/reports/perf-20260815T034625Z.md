...
```json
{
  ...
  "database": "D:\\DuAnCAm\\.tmp\\pytest\\pytest-of-Admin\\pytest-6\\test_isolated_smoke_and_write_0\\smoke.db"
}
```

| Kịch bản | Tải | Requests | Success | Error rate | P50 | P95 | P99 | CPU P95 | RAM max | Event mất | Event trùng | Kết quả |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| isolated_smoke | sequential low load | 3 | 3 | 0.00 | 1714.42 | 1786.72 | 1793.15 | 73.13 | 96.34 | 0 | 0 | FAIL |
