...
```json
{
  ...
  "database": "D:\\DuAnCAm\\.tmp\\pytest\\pytest-of-Admin\\pytest-5\\test_isolated_smoke_and_write_0\\smoke.db"
}
```

| Kịch bản | Tải | Requests | Success | Error rate | P50 | P95 | P99 | CPU P95 | RAM max | Event mất | Event trùng | Kết quả |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| isolated_smoke | sequential low load | 3 | 3 | 0.00 | 404.72 | 406.29 | 406.43 | 95.38 | 96.55 | 0 | 0 | FAIL |
