...
export interface CameraDetail { id:string; name:string; room:string; status:CameraStatus; quality:"HD"; lastUpdatedAt:string; videoUrl:string; streamUrl:string; streamReady:boolean; monitoringStatus:"active"|"paused"; safetyStatus:"safe"|"attention"; }
export interface CameraEvent { id:string; eventId:string; cameraId:string; type:CameraEventType; title:string; description:string; occurredAt:string; dayGroup:"Hôm nay"|"Hôm qua"|"28 tháng 7"; severity:CameraEventSeverity; status:CameraEventStatus; confidence?:number; isRead:boolean; notes?:string; }
