...
import { WebcamProvider } from "./features/webcam/WebcamProvider";
...
function currentPath(): RoutePath {
  ...
  return routePaths.has(pathname)
...
function DashboardApp({
  ...
  const [activePath, setActivePath] =
    useState<RoutePath>(currentPath);

  const [routeRevision, setRouteRevision] =
    useState(0);
                ...
                return (
                  ...
                  >
                    ...
                    {badge > 0 ? (
                      <span
                        className="nav-badge"
                        aria-label={`${badge} cảnh báo chưa đọc`}
                      >
                        {badge > 99
                          ? "99+"
                          : badge}
