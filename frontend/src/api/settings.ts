...
export interface SettingsCamera { id:string; name:string; location_label:string; operational_status:"online"|"offline"|"error"; last_seen_at?:string|null; is_active:boolean; source_kind:string; }
